package com.example.gooru.core.tach
...
fun  RecyclerView.setItemTouchHelper(limitScrollX: Int) {
    ...
    ItemTouchHelper(object : ItemTouchHelper.Callback() {
        ...
        override fun getSwipeThreshold(viewHolder: RecyclerView.ViewHolder) = Integer.MAX_VALUE.toFloat()
        ...
        private fun scrollItemByGesture(
            ...
            val scrollOffset = (currentScrollX + (-dX).toInt()).coerceIn(minimumValue = 0, maximumValue = limitScrollX)
        ...
        attachToRecyclerView(this@setItemTouchHelper)
    }
}